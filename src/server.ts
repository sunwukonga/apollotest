...
const typeDefs = gql`
  ...
  "This type is for storing book data"
  type Book {
    """
    The title is cool
    It lets you find a book again, which I suppose must be useful. I'm am just testing the length of comment now though.
    """
    title: String
    "Authors can also be cool"
    author: String
  }
